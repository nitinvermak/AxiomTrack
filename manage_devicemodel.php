...
<div class="row" id="content">
    ...
    <input type='hidden' name='pagename' value='users'>
    	<div class="col-md-4 btn_grid">
     		<input type='button' name='cancel' class="btn btn-primary btn-sm" value="Add New" onClick="window.location.replace('devicemodel.php?token=<?php echo $token ?>')"/>
       &nbsp;&nbsp;&nbsp;
   ...
   <?php } ?>
      ...
      <a href="devicemodel.php?id=<?php echo $row["device_id"] ?>&token=<?php echo $token ?>">
      <img src='images/edit.png' title='Edit' border='0' />
      </a>
      &nbsp;&nbsp;
      <input type='checkbox' name='linkID[]' value='<?php echo $row["device_id"]; ?>'>
      </td>
      </tr>
<?php }
		echo $pagerstring;
