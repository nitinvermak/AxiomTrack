...
{
$msgDanger = "Customer Type already exists";
}
}
}
              ...
              <div class="small-form">
                <form name='myform' action="" method="post" onSubmit="return validate(this)">
                  ...
                  <div class="form-group">
                    <label>Customer Type<i>*</i></label>
                    <input type="text" name="customer_type" id="customer_type" class="form-control text_box" value="<?php if(isset($result['customer_type_id'])) echo $result['customer_type'];?>" />
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
                    ...
                    <input type='button' name='cancel2' class="btn btn-primary btn-sm" value="Back"onclick="window.location='manage_customer_type.php?token=<?php echo $token ?>'"/>
                  </div> <!-- form-group -->
                </form>
              </div>
            </div>
