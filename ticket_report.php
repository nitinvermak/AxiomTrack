...
<div class="row" id="content">
    ...
    <form name='fullform' class="form-horizontal"  method='post' onSubmit="return confirmdelete(this)">
     ...
     <td class="col-xs-2"><input type="text" name="date" id="date" class="form-control text_box-sm"/></td>
     <td class="col-xs-1"><strong>Branch*</strong></td>
<td class="col-xs-2"><select name="branch" id="branch" class="form-control drop_down-sm">
...
<td class="col-xs-2"><select name="executive" id="executive" class="form-control drop_down-sm">
     ...
     <td>&nbsp;</td>
     <td><input type="button" name="assign" value="Submit" id="submit" class="btn btn-primary btn-sm pull-left"  onclick="ShowReport()" />&nbsp;<input type="button" name="assign" value="Summary" onClick="window.location.replace('ticket_summary.php?token=<?php echo $token;?>')" id="submit" class="btn btn-primary btn-sm" /></td>
     <td>&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
      <tr>
