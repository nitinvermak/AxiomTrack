...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Request Type</li>
      </ol>
    </section>
    <!-- Main content -->
              ...
              <div class="small-form">
                <form name='myform' action="" method="post" onSubmit="return validate(this)">
                  ...
                  <div class="form-group">
                    <label>Products<i>*</i></label>
                    <select name="product" id="product" class="form-control drop_down select2" style="width: 100%">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="request_type" id="request_type" class="form-control text_box" value="<?php if(isset($result['id'])) echo $result['rqsttype'];?>" />
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
                    ...
                    onclick="window.location='manage_request_type.php?token=<?php echo $token ?>'"/>
                  </div> <!-- form-group -->
                </form>
              </div>
            </div>
