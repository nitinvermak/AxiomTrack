...
function getDistrict(){
  if ($("#district").val() == "") {
    ...
    $(".loader").show();
    $.post("ajaxrequest/district_details.php?token=<?php echo $token ?>",{
            ...
            <div class="box-body">
              <div class="col-lg-12">
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <span><strong>Disrict</strong><i class="red">*</i></span>
                  <input type="text" name="district" id="district" class="form-control">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <span>&nbsp;</span><br>
                  <button type="button" name="district" id="district" class="btn btn-primary btn-sm" onclick="getDistrict()">Search</button>
                </div>
              </div>
              <div class="col-lg-12">
              ...
              <div class="col-lg-12 table-responsive" id="dvdata" style="margin-top: 20px;"></div>
            </div>
            <!-- /.box-body -->
        </div>
    </form>
