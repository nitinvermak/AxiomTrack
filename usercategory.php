...
{
$msgDanger="User Category already exists";
}
}
}
              ...
              <div class="small-form">
                <form name='myform' action="" method="post" onSubmit="return validate(this)">
                  ...
                  <div class="form-group">
                    <label>User Category<i>*</i></label>
                    <input type="text" name="user_category" class="form-control" value="<?php if(isset($result['id'])) echo $result['User_Category'];?>" />
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
                    <label>Description<i>*</i></label>
                    <textarea name="description" class="form-control"><?php if(isset($result['id'])) echo $result['Description'];?></textarea>
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
                    ...
                    onclick="window.location='manage_user_category.php?token=<?php echo $token ?>'"/>
                  </div> <!-- form-group -->
                </form>
              </div>
            </div>
