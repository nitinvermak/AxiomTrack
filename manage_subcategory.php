...
<div class="row" id="content">
   ...
   <?php } ?>
      ...
      <th class="col-md-3"><small>Product Category</small></td>  
      <th class="col-md-5"><small>Product Sub Category</small></th>  
	  ...
	  <td><?php if($row["planSubid"]!=1){?><a href="#" onClick="if(confirm('Do you really want to delete this record?')){ window.location.href='manage_category.php?id=<?php echo $row["planSubid"]; ?>&type=del&token=<?php echo $token ?>' } " ><img src="images/drop.png" title="Delete" border="0" /></a> <?php } ?>    <?php if($row["planSubid"]!=1){?><a href="add_branch_category.php?id=<?php echo $row["planSubid"] ?>&token=<?php echo $token ?>"><a href="plansub_category.php?id=<?php echo $row["planSubid"] ?>&token=<?php echo $token ?>"><img src='images/edit.png' title='Edit' border='0' /></a><?php } else {?> <a href="plansub_category.php?cid=<?php echo $row["planSubid"] ?>&token=<?php echo $token ?>"><img src='images/edit.png' title='Edit' border='0' /></a> <?php } ?> &nbsp;&nbsp;<?php if($row["planSubid"]!=1){?>
                        <input type='checkbox' name='linkID[]' value='<?php echo $row["planSubid"]; ?>'><?php } ?></a> </td>
      </tr>
<?php }
		echo $pagerstring;
	  }
