...
<script type="text/javascript">
   function getPincode(){
        if ($('#pincode').val() == "") {
            ...
            $('.loader').show();
            $.post("ajaxrequest/pincode_details.php?token=<?php echo $token;?>",
            {
                pincode : $('#pincode').val()
            },
            function(data){
            ...
            <div class="box-body">
                <div class="col-lg-12">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <span><strong>Pincode</strong><i class="red">*</i></span>
                        <input type="text" name="pincode" id="pincode" class="form-control">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <span>&nbsp;</span><br>
                        <button type="button" name="pincode" id="pincode" onclick="getPincode()" class="btn btn-primary btn-sm">Search</button>
                    </div>
                </div>
                <div class="col-lg-12">
