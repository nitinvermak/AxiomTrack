...
<div class="row" id="content">
    ...
    <div class="table-responsive">
	  ...
	  <td>
      <a href="#" onClick="if(confirm('Do you really want to delete this record?')){ window.location.href='manage_city.php?id=<?php echo $row["City_id"]; ?>&type=del&token=<?php echo $token ?>' } " >
      <img src="images/drop.png" title="Delete" border="0" />
      </a> 
      <a href="add_city.php?id=<?php echo $row["City_id"] ?>&token=<?php echo $token ?>">
