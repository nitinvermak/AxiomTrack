            ...
            <div class="form-group form_custom col-md-12"> <!-- form Custom -->
                <div class="row"><!-- row -->
                    <div class="col-lg-6 col-sm-6 custom_field"> <!-- Custom field -->
                        ...
                        <select name="branch" id="branch" class="form-control select2" style="width: 100%">
                            ...
                            {
                                echo '<option label="" value="" selected="selected">--Select--</option>';
                            }
                            //echo $branch_sql;
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 custom_field"> <!-- Custom field -->
                        ...
                        <input type="text" name="search_box" id="search_box" class="form-control" placeholder="Search by Sim or Mobile No."  />
...
$(document).ready(function(){
    $('#submit').click(function(){
        $('.loader').show();
        $.post("ajaxrequest/sim_report.php?token=<?php echo $token;?>",
                {
