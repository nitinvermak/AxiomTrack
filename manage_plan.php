            ...
            <div class="box-body">
                <div id="dvData" class="table-responsive">
                    ...
                    <table id="example" class="table table-hover table-bordered ">
                        <thead>
                            <?php    
                            $linkSQL = "select * from tblplan order by plan_name";
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><small><?php echo stripslashes($row["plan_rate"]);?></small></td>
                                <td><small><a href="#" onClick="if(confirm('Do you really want to delete this record?')){ window.location.href='manage_plan.php?id=<?php echo $row["id"]; ?>&type=del&token=<?php echo $token ?>' }" ><img src="images/drop.png" title="Delete" border="0" /></a>     <a href="plan.php?id=<?php echo $row["id"] ?>&token=<?php echo $token ?>"><img src='images/edit.png' title='Edit' border='0' /></a> &nbsp;&nbsp;<input type='checkbox' name='linkID[]' value='<?php echo $row["id"]; ?>'></small></td>
                            </tr>
                        <?php }
                            }
                            ?> 
