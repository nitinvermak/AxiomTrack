...
function ShowbyCategory(){   
    ...
    /*alert(organization);*/
    url="ajaxrequest/show_customers_type_details.php?organization="+organization+"&token=<?php echo $token;?>";
    /*alert(url);*/
            ...
            <div class="form-group form_custom col-md-12"> <!-- form Custom -->
                <div class="row"><!-- row -->
                    <div class="col-lg-6 col-sm-6 custom_field"> <!-- Custom field -->
                        ...
                        <select name="organization" id="organization" onChange="return ShowbyCategory();" class="form-control drop_down select2">
                            ...
                            ?>
                <option value="<?php echo $resultCountry['Company_Name']; ?>" ><?php echo stripslashes(ucfirst($resultCountry['Company_Name'])); ?></option>
                <?php } ?>
                </select>
