...
{
  $msgDanger = "Module Category already exists";
}
}
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Module Category</li>
      </ol>
    </section>
    <!-- Main content -->
              ...
              <div class="small-form">
                <form name='myform' action="" method="post" onSubmit="return validate(this)">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="<?php if(isset($result['moduleCatId'])) echo $result['moduleCategory'];?>" />
                  </div><!-- /.form group -->
                  <div class="form-group">
                    <label>Display Name<i>*</i></label>
                    <input type="text" name="displayName" id="displayName" class="form-control" value="<?php if(isset($result['moduleCatId'])) echo $result['displayname'];?>" />
                  </div><!-- /.form group -->
                  <div class="form-group">
                    ...
                    onclick="window.location='manage_module_category.php?token=<?php echo $token ?>'"/>
                  </div> <!-- form-group -->
                </form>
              </div>
            </div>
