...
if(isset($_REQUEST['cid']) && $_REQUEST['cid']!=''){
    $sql="update tbl_district set State_id = '$state', District_name='$district' 
          where District_id=" .$_REQUEST['id'];
...
{
    $msgDanger = "District already exists";
}
}
}
              ...
              <div class="small-form">
                <form name='myform' action="" method="post" onSubmit="return validate(this)">
                  ...
                  <div class="form-group">
                    ...
                    <select name="state" class="form-control input-sm select2" style="width: 100%" id="state"   
                  ...
                  <div class="form-group">
                    ...
                    <input name="district" id="district" type="text" class="form-control" value="<?php if(isset($result['District_id'])) echo $result['District_name']; ?>"/>
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
                    ...
                    <input type='button' name='cancel2' class="btn btn-primary btn-sm" value="Back"onclick="window.location='manage_district.php?token=<?php echo $token ?>'"/>
                  </div> <!-- form-group -->
                </form>
              </div>
            </div>
