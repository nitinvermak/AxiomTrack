...
{
$msgDanger = "Data Source Already Exists";
}
}
}
              ...
              <div class="small-form">
                <form name='myform' action="" method="post" onSubmit="return validate(this)">
                  ...
                  <div class="form-group">
                    <label>Data Source<i>*</i></label>
                    <input type="text" class="form-control text_box" name="datasource" id="datasource" value="<?php if(isset($result['id'])) echo $result['datasource'];?>" />
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
