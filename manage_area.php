...
<script type="text/javascript">
    ...
    function getAreas(){
        if ($('#areaname').val() =="") {
            ...
            $('.loader').show();
            $.post("ajaxrequest/area_details.php?token=<?php echo $token;?>",
                    {
            ...
            <div class="box-body">
                <div class="col-lg-12">
                    <div class="col-lg-6 col-sm-6 col-md-6">
                        <span><strong>Area</strong> <i class="red">*</i></span>
                        <input type="text" name="areaname" id="areaname" class="form-control">
                    </div>
                    <div class="col-lg-6 col-sm-6 col-md-6">
                        <span><strong>&nbsp;</strong></span><br>
                        <button type="button" name="areaname" id="areaname" class="btn btn-primary btn-sm" 
                        onclick="getAreas()">Search</button>
                    </div>
                </div>
                <div class="col-lg-12">
                ...
                <div id="dvData" class="table-responsive col-lg-12" style="margin-top: 20px;">
