            ...
            <div class="box-body">
                <div id="dvData" class="table-responsive">
                    ...
                    <table id="example" class="table table-hover table-bordered ">
                      <thead>
                      <?php 
                      $linkSQL = "select * from tblcountry order by Country_name";
                      ...
                      ?>
                        <tr>
                          ...
                          <td><a href="#" onClick="if(confirm('Do you really want to delete this record?')){ window.location.href='manage_country.php?id=<?php echo $row["Country_id"]; ?>&type=del&token=<?php echo $token ?>' } " >
                          ...
                          &nbsp;&nbsp;
                          <input type='checkbox' name='linkID[]' value='<?php echo $row["Country_id"]; ?>'>
                          </td>
                        </tr>
                      <?php 
                        }
