...
{
$msgDanger="Parent Module Name already exists";
}
}
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Parent Module</li>
      </ol>
    </section>
    <!-- Main content -->
              ...
              <div class="small-form">
                <form name='myform' action="" method="post" onSubmit="return validate(this)">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="parentModule" id="parentModule" class="form-control" value="<?php if(isset($result['parentId'])) echo $result['parentName'];?>" />
                  </div><!-- /.form group -->
                  <div class="form-group">
                    ...
                    onclick="window.location='manage_parent_module.php?token=<?php echo $token ?>'"/>
                  </div> <!-- form-group -->
                </form>
              </div>
            </div>
