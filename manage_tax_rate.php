...
<div class="row" id="content">
   ...
   <?php
    	...
    	if(!isset($linkSQL) or $linkSQL =='')		
     	$linkSQL = "select * from tbltaxtype as A 
					INNER JOIN tbltax as B
					ON A.taxTypeId = B.taxTypeId
					order by B.taxRate";
  		$pagerstring = Pages($linkSQL,PER_PAGE_ROWS,'manage_tax_rate.php?',$token);
   ...
   <?php } ?>
      ...
      <th><small>Tax Type</small></th>    
      <th><small>Tax Rate</small></th>   
      </tr>    
	  <?php
		$kolor=1;
	  ...
	  <td><small><?php echo stripslashes($row["taxType"]);?></small></td>
      <td><small><?php echo stripslashes($row["taxRate"]);?></small></td>
      </tr>
<?php }
		echo $pagerstring;
	  }
