...
<div class="row" id="content">
    ...
    <div class="col-md-12">
    	...
    	<table border="0">
        <tr >
        <td><strong>Add Accessories</strong></td>
        <td><?php if(isset($msg) && $msg !="") echo "<font color=red>".$msg."</font>"; ?></td>
        </tr>
        <tr >
        <td>Add  Name*</td>
        <td><input type="text" name="name" id="name" class="form-control text_box" value="<?php if(isset($result['id'])) echo $result['name'];?>" /></td>
        </tr>
        <tr>
        <td> </td>
