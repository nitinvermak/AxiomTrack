...
{
  $msgDanger="Accessories already exists";
}
}
}
if(isset($_REQUEST['id']) && $_REQUEST['id']){
$queryArr=mysql_query("select * from tblaccessories where id =".$_REQUEST['id']);
$result=mysql_fetch_assoc($queryArr);
}
?>
<!DOCTYPE html>
...
<script type="text/javascript" src="js/manage_accessories.js"></script>
<script>
$(function() {
              ...
              <div class="small-form">
                <form name='myform' action="" method="post" onSubmit="return validate(this)">
                  ...
                  <div class="form-group">
                    <label>Add  Name<i>*</i></label>
                    <input type="text" name="name" id="name" class="form-control" value="<?php if(isset($result['id'])) echo $result['name'];?>" />
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
                    ...
                    onclick="window.location='manage_accessories.php?token=<?php echo $token ?>'"/>
                  </div> <!-- form-group -->
                </form>
              </div>
            </div>
