...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $delete_single_row = "DELETE FROM vehiclebrand WHERE id='$id'";
...
if(isset($_POST['delete_selected'])){
    foreach($_POST['linkID'] as $chckvalue){
        $sql = "DELETE FROM vehiclebrand WHERE id='$chckvalue'";
            ...
            <div class="form-group form_custom col-md-12"> <!-- form Custom -->
                <div class="row"><!-- row -->
                    <div class="col-lg-6 col-sm-6 custom_field"> <!-- Custom field -->
                       <input type='button' name='cancel' class="btn btn-primary btn-sm" value="Add New" onClick="window.location.replace('add_vehiclebrand.php?token=<?php echo $token ?>')"/>
                       &nbsp;&nbsp;&nbsp;
            ...
            <div class="box-body">
                <div id="dvData" class="table-responsive">
                    ...
                    <table id="example" class="table table-hover table-bordered ">
                        <thead>
                            <?php    
                            $linkSQL = "select * from vehiclebrand order by brandName";
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><small><?php echo $row["brandName"] ?></small></td>
                                <td><small><a href="#" onClick="if(confirm('Do you really want to delete this record?')){ window.location.href='manage_vehicle_brand.php?id=<?php echo $row["id"]; ?>&type=del&token=<?php echo $token ?>' }" ><img src="images/drop.png" title="Delete" border="0" /></a>     <a href="add_vehiclemodel.php?id=<?php echo $row["id"] ?>&token=<?php echo $token ?>"><img src='images/edit.png' title='Edit' border='0' /></a> &nbsp;&nbsp;<input type='checkbox' name='linkID[]' value='<?php echo $row["id"]; ?>'></small></td>
                            </tr>
                        <?php }
                            }
                            ?> 
