...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Plan Period</li>
      </ol>
    </section>
    <!-- Main content -->
              ...
              <div class="small-form">
                <form name='myform' action="" method="post" onSubmit="return validate(this)">
                  ...
                  <div class="form-group">
                    <label>Plan Period<i>*</i></label>
                    <input type="text" name="plan_period" id="plan_period" class="form-control" value="<?php if(isset($result['id'])) echo $result['period'];?>" />
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
                    <input type='submit' name='submit' class="btn btn-primary btn-sm" value="Submit"/>
                    <input type='reset' name='reset2' class="btn btn-primary btn-sm" value="Reset"/>
                    <input type='button' name='cancel2' class="btn btn-primary btn-sm" value="Back"onclick="window.location='manage_plan_period.php?token=<?php echo $token ?>'"/>
                  </div> <!-- form-group -->
                </form>
              </div>
            </div>
