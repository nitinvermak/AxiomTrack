        ...
        <form name='fullform' action="generate_invoice_pdf.php" id="fullform" class="form-inline"  method='post' onSubmit="return confirmdelete(this)">
                 <div class="col-lg-12 table-responsive">
                   ...
                   <table width="100%" border="1">
                    ...
                    <tr>
                      <td width="33%" style="padding: 5px;"><span><strong>Invoice No.:</strong> 
                        <?= $invoice_No; ?>
                        <input type="hidden" name="invoice_No" id="invoice_No" value="<?= $invoice_No; ?>">
                        </span></td>
                      <td width="33%" style="padding: 5px;"><span><strong>Invoice Date:</strong> 
                   ...
                   <table width="100%" border="1">
                    <tr>
                      <td width="15%" style="padding: 5px;"><span><strong>No. of Vehicles:</strong> 
                        <?= $total_vehicle;?>
                        <input type="hidden" name="total_vehicle" value="<?= $total_vehicle;?>">
                      </span></td>
                      <td width="30%" style="padding: 5px;"><span><strong>Rent Period:</strong> <input type="hidden" name="from_period" value="<?= date("d-m-Y", strtotime($from)); ?>">
                      <?= date("d-m-Y", strtotime($from)); ?> To <?= date("d-m-Y", strtotime($to)); ?> 
                        <input type="hidden" name="to_period" value="<?= date("d-m-Y", strtotime($to)); ?>"> </span></td>
                      <td width="15%" style="padding: 5px;"><span><strong>Amount:</strong>
                      ...
                      <td width="20%" style="padding: 5px;"><span><strong>Tax Amount:</strong> 
                      <?php $summ_tax = $summ_total/100 * 15;
                  ...
                  <table width="100%" border="1">
                    ...
                    <tr>
                      <td width="6%" style="padding: 5px;"><span><strong>S.No.</strong></span></td>
                      <td width="16%" style="padding: 5px;"><span><strong>Vehicle No.</strong></span></td>
                      <td width="28%" style="padding: 5px;"><span><strong>Rent Period</strong></span></td>
                 ...
                 <div class="col-lg-12">
                   <button type="button" name="print" onclick="get_print()" class="btn btn-primary btn-sm pull-left">Print</button>
