...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Branch Category Details
        <!--<small>Control panel</small>-->
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Branch Category Details</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="form-group form_custom col-md-12"> <!-- form Custom -->
                <div class="row"><!-- row -->
                    <div class="col-lg-6 col-sm-6 custom_field"> <!-- Custom field -->
                        <input type='button' name='cancel' class="btn btn-primary btn-sm" value="Add New" 
                        onClick="window.location.replace('add_branch_category.php?token=<?php echo $token ?>')"/>
                        &nbsp;&nbsp;
            ...
            <div class="box-body">
                <div id="dvData" class="table-responsive">
                    ...
                    <table id="example" class="table table-hover table-bordered ">
                        <thead>
                            <?php    
                            $linkSQL = "select * from tblbranchtype order by id desc";
                            $oRS = mysql_query($linkSQL); 
                            ?>
                            <tr>
                                <th><small>S. No.</small></th>     
                                <th><small>Branch Category</small></th>  
                                <th><small>Branch Description</small></th>  
                                <th><small>Action &nbsp;             
