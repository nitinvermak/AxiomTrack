...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Customer Type Details</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="form-group form_custom col-md-12"> <!-- form Custom -->
                <div class="row"><!-- row -->
                    <div class="col-lg-6 col-sm-6 custom_field"> <!-- Custom field -->
                       <input type='button' name='cancel' class="btn btn-primary btn-sm" value="Add New" onClick="window.location.replace('add_customer_type.php?token=<?php echo $token ?>')"/>
                       &nbsp;&nbsp;&nbsp;
            ...
            <div class="box-body">
                <div id="dvData" class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" onClick="if(confirm('Do you really want to delete this record?')){ window.location.href='manage_customer_type.php?id=<?php echo $row["customer_type_id"]; ?>&type=del&token=<?php echo $token ?>' } " >
                            <img src="images/drop.png" title="Delete" border="0" />
                            </a>
                            <a href="add_customer_type.php?id=<?php echo $row["customer_type_id"] ?>&token=<?php echo $token ?>">
                            <img src='images/edit.png' title='Edit' border='0' />
                            </a>
                            &nbsp;&nbsp;
                            <input type='checkbox' name='linkID[]' value='<?php echo $row["customer_type_id"]; ?>'>
                        </td>
                    </tr>
                    <?php }
                        echo $pagerstring;
