...
?>
	...
	<!-- Make payement modal -->
	        ...
	        <td>
	        	<button type="button" class="btn btn-danger btn-sm" onclick="deleteEstimate(<?php echo $invoiceId; ?>);">
	        		Delete Invoice 
	        	</button><br><br>
			 
	       		<!---
				<button type="button" class="btn btn-info btn-sm" onclick="restoreDueDate(<?php echo $invoiceId; ?>);">
	       			Restore Due Date
	       		</button><br><br>
	       		<button type="button" class="btn btn-info btn-sm" onclick="reGenerateEstimate();">
