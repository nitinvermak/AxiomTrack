...
$callingdata_id = mysql_real_escape_string($_POST['callingdata_id']);
...
$UpdateCallingData = "UPDATE tblcallingdata SET First_Name = '$first_name', Last_Name = '$last_name', 
                ...
                data_source = '$datasource' where id =".$callingdata_id;
...
$UpdateCustomerMaster = "UPDATE `tbl_customer_master` SET `LeadGenBranchId`='$branch', 
                        ...
                        `rent_payment_mode`='$rentFrq' WHERE `callingdata_id` ='$callingdata_id'";
