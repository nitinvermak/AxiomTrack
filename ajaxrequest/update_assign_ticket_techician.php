...
if ($ticket_id  == 0)
{
	...
	$linkSQL = "SELECT * FROM tblticket as A
				...
				ON A.ticket_id = B.ticket_id 
				INNER JOIN tbl_ticket_assign_technician as C
				ON B.ticket_id = C.ticket_id WHERE A.ticket_id='$ticket_id' and A.ticket_status='0'";
	...
	<?php
 	...
 	?>
                 ...
                 <td valign="middle" class="txt" align="left">
                   <a href="close_ticket.php?ticket_id=<?php echo $row["ticket_id"];?>&token=<?php echo $token ?>" ><img src="images/drop.png" title="Close" border="0" /></a>&nbsp;&nbsp;  <a href="close_ticket.php?ticket_id=<?php echo $row["ticket_id"];?>&token=<?php echo $token ?>"><span>Reschedule</span></a>
                 </td>
                 </tr>
	<?php 
	      }
