...
<select name="oldmobileNo" id="oldmobileNo" class="form-control drop_down">
	...
	?>
    <option value="<?php echo $resultCountry['mobile_no']; ?>"><?php echo getMobile(stripslashes(ucfirst($resultCountry['mobile_no']))); ?></option>             <?php } ?>
</select>
			</div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-10">
    	<select name="olddeviceId" id="olddeviceId" class="form-control drop_down" onChange="getValue();">
