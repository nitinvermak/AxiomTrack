...
if(mysql_num_rows($stockArr)>0)
	{
	 	...
	 	echo '  <table class="table table-hover table-bordered" id="example">  ';
	 		echo "<thead>";
?>		
...
?> 
                          ...
                          <table>
                          <tr>
                          <td colspan="3"><input type="submit" name="ticketConfirm" value="Submit" class="btn btn-primary btn-sm" onClick="return val();" id="submit" /> </td>
                          <td></td>
                          </tr>
                          </table>
                   	    </form>   
