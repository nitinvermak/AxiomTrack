...
<div class="modal-body">
  <div class="col-md-12" id="dv_success">
    <p><strong>Generated Date:</strong> <input type="text" name="generated_date" id="generated_date" class="form-control" onchange="get_intervalId();" readonly="">
     <!-- <strong>Payment Due Date:</strong> <input type="text" name="due_date1" id="due_date1" class="form-control date"> -->
          ...
          <tr>
            ...
            <tr class="row_val">
              ...
              <td><?php echo getPlanAmt($row['rentamt']); ?>
                  ...
                  <input type="hidden" name="plan_rate_id" id="plan_rate_id_<?= $row['vId']; ?>" class="plan_rate_id" value="<?= $row['rentamt']; ?>">
              </td>
