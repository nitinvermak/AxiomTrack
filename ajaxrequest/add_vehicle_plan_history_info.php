...
if($device_type == 4)
	{	
		...
		$sql = "Insert into tbl_gps_vehicle_payment_master set cust_id = '$custid', instalmentId='$instalmentId', Vehicle_id = '$vehicle_id', 
		device_type = '$device_type', device_amt = '$device_amt', device_rent_amt = '$device_rent',
		installation_charges = '$installation_charges', RentalFrequencyId='$rent_frq',PlanStartDate=Now(),
		PlanendDate=' ', PlanactiveFlag='Y' , next_due_date ='$next_due_date' ";
		/*echo 'comnd' .$sql;*/
		// echo $sql;
		$result = mysql_query($sql);
		echo  "<p style = 'color:green; font-weight:bold;'> Plan Updated !</p>";
...
else
	{
		...
		/*echo $change_status; */
		$change = mysql_query($change_status);
		$sql = "Insert into tbl_gps_vehicle_payment_master set cust_id = '$custid', Vehicle_id = '$vehicle_id ', 
				device_type = '$device_type', device_amt = '$device_amt', device_rent_amt = '$device_rent', 
				installation_charges = '$installation_charges', RentalFrequencyId='$rent_frq', PlanStartDate=Now(), 
				PlanendDate=' ', PlanactiveFlag='Y' ,  next_due_date ='$next_due_date'";
		// echo 'comnd' .$sql;
