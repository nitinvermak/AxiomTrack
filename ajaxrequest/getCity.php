...
$branchArr=mysql_query("select distinct city_name from tblcity where tblcity.state_id=(select State_id from tblstate where State_name='".$state_id."') order by city_name");
