...
{
$Status=htmlspecialchars(mysql_real_escape_string(trim($_REQUEST['status'])));
}
...
$queryArr=mysql_query("select * from tblstatus where Status ='$Status'");
...
$queryArr=mysql_query("select * from tblstatus where id =".$_REQUEST['id']);
$result=mysql_fetch_assoc($queryArr);
}
?>
<!DOCTYPE html>
...
<script type="text/javascript" src="js/manage_status.js"></script>
</head>
<body>
<!--open of the wraper-->
<div id="wraper">
...
<div class="row" id="content">
    ...
    <div class="col-md-12">
        ...
        <tr>
        <td>Status*</td>
        <td><input type="text" name="status" class="form-control text_box" value="<?php if(isset($result['id'])) echo $result['Status'];?>" /></td>
        </tr>
        <tr>
        <td></td>
