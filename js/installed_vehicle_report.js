...
function ShowReport()
	{   
		...
		/*alert(date);*/
		url="ajaxrequest/vehicle_report_by_date.php?date="+date+"&dateto="+dateto+"&company="+company+"&reffered="+reffered+"&technician="+technician+"&token=<?php echo $token;?>";
		/*alert(url);*/
...
function downloadCSV()
	{
		...
		technician = document.getElementById("technician").value;
		/*alert(date);*/
		url="ajaxrequest/vehicle_report_export.php?date="+date+"&dateto="+dateto+"&company="+company+"&reffered="+reffered+"&technician="+technician+"&token=<?php echo $token;?>";
		/*alert(url);*/
		xmlhttpPost(url,date,"getCSV");
	}
function getCSV(str){
	document.getElementById('divassign').innerHTML=str;
	}