...
<div class="row" id="content">
	<div class="col-md-12">
    	<h3>Device Company  Details</h3>
        <hr>
    </div>
    <div class="col-md-12">
    	<div class="col-md-4 btn_grid">
     		<input type='button' name='cancel' class="btn btn-primary" value="Add New" onClick="window.location.replace('device_company.php?token=<?php echo $token ?>')"/>
       &nbsp;&nbsp;&nbsp;
