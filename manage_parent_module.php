...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Parent Module Details</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div id="dvData" class="table-responsive">
                    ...
                    <?php
                    $linkSQL = "Select tblmoduleparentname.parentName as parent,
                                tblmoduleparentname.parentId as parentId, 
                                tblmodulecategory.moduleCategory as category 
                    ...
                    <tr>
                        ...
                        <td><a href="add_parent_module.php?id=<?php echo $row['parentId'] ?>&token=<?php echo $token ?>"><img src='images/edit.png' title='Edit' border='0' /></a> &nbsp; &nbsp;<input type='checkbox' name='linkID[]' value='<?php echo $row["id"]; ?>'></td>
                    </tr>
                    <?php }
                    }
                    ?> 
