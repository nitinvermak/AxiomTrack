...
WHERE A.id = B.callingdata_id and B.callingdata_id ='$id'");
    ...
    <td valign="top"><select name="customer_type" id="customer_type" class="form-control drop_down">
      <option value="">Select</option>
    ...
    <td valign="top"><select name="installment_amt" id="installment_amt" class="form-control drop_down">
      <option value="">Installment Amt.</option>
