...
{
$msgDanger="Service Provider Name already exists";
}
}
}
              ...
              <div class="small-form">
                <form name='myform' action="" method="post" onSubmit="return validate(this)">
                  ...
                  <div class="form-group">
                    <label>Service Provider Name<i>*</i></label>
                    <input type="text" name="serviceprovider" id="serviceprovider" class="form-control text_box" value="<?php if(isset($result['id'])) echo $result['serviceprovider'];?>" />
                  </div>
                  <!-- /.form group -->
                  <div class="form-group">
                    ...
                    onclick="window.location='manage_serviceprovider.php?token=<?php echo $token ?>'"/>
                  </div> <!-- form-group -->
                </form>
              </div>
            </div>
